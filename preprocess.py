...
if __name__ == '__main__':
    ...
    parser.add_argument("-oracle_mode", default='each', type=str, help='how to generate oracle summaries, greedy or combination, combination will generate more accurate oracles but take much longer time.')
